...
{
    [[self sharedManager] defaultPostWithMethod:kMethodSendCode WithParameters:parameters success:success failure:failure];
}
...
{
    [[self sharedManager] defaultPostWithMethod:kMethodRegister WithParameters:parameters success:success failure:failure];
}
...
{
    [[self sharedManager] defaultPostWithMethod:kMethodForgotPassword WithParameters:parameters success:success failure:failure];
}
