...
class ContactLaunchApointmentTableViewController: UITableViewController {
    ...
    @IBAction func timeButtonClicked(sender: AnyObject) {
        var actionSheet = ActionSheetDatePicker(title: "", datePickerMode: UIDatePickerMode.Date, selectedDate: NSDate(), doneBlock: {
