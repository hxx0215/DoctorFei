...
+ (instancetype)sharedAGViewDelegate {
...
- (void)viewOnWillDisplay:(UIViewController *)viewController shareType:(ShareType)shareType
{
    ...
    viewController.navigationController.navigationBar.barTintColor = [UIColor colorWithRed:63.0/255.0 green:164.0/255.0 blue:0.0 alpha:1.0];
